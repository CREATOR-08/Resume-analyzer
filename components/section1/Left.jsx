    ...
    <div className="flex flex-col items-center justify-center w-full">
      <div className="w-full max-w-2xl rounded-3xl bg-gradient-to-br from-gray-900 to-gray-950 p-8 md:p-10 shadow-2xl border border-zinc-800">
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-white leading-tight mb-8">
          {logged ? "Start your next resume analysis" : "Login to unlock your resume analysis"}
        </h2>
        ...
        <p className="mb-8 text-zinc-400 text-sm md:text-base leading-relaxed">
          {logged
            ? "Run a fresh resume scan and save the results to your dashboard."
            : "Sign in to see your personalized resume score, JD match, and next-step suggestions."}
        </p>
        <Link
